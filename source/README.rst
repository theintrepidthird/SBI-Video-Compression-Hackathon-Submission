...
The Presentation can be found in `PDF <https://github.com/theintrepidthird/SBI-Video-Compression-Hackathon-Submission/blob/main/source/report.pdf>`__ , as well as in `PDF <https://github.com/theintrepidthird/SBI-Video-Compression-Hackathon-Submission/blob/main/source/report(with%20pauses).pdf>`__ with pauses.
